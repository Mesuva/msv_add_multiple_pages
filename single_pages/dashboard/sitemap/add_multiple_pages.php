...
<?php
// included here for v8 support
$app->make('help/dashboard')->registerMessages(['/dashboard/sitemap/add_multiple_pages'=> \Concrete\Package\MsvAddMultiplePages\Controller::returnHelp() ]);
?>
